...
class HistoryViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: String(describing: RequestDetailTableViewCell.self), bundle: nil), forCellReuseIdentifier: String(describing: RequestDetailTableViewCell.self))
