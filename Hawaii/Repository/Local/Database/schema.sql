...
CREATE TABLE IF NOT EXISTS `pushToken` (`id` INTEGER NOT NULL, `name` TEXT, `platform` TEXT, `pushToken` TEXT,`user_id` INTEGER, PRIMARY KEY(`id`), FOREIGN KEY(user_id) REFERENCES user(id));
COMMIT;
