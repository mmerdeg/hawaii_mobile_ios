...
CREATE TABLE IF NOT EXISTS `token` (`id` INTEGER NOT NULL, `name` TEXT, `platform` TEXT, `push_token` TEXT , `user_id` INTEGER, PRIMARY KEY(`id`), FOREIGN KEY (user_id) REFERENCES user(id));
COMMIT;
