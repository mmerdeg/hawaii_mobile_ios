...
class RequestRepository: RequestRepositoryProtocol {
    func getAll(completion: @escaping ([Request]) -> ()) {
        ...
        let day1 = Day(id: 1, date: formatter.date(from: "2018-06-01 00:00:00 +0000")!, duration: .morning)
        let day2 = Day(id: 2, date: formatter.date(from: "2018-06-02 00:00:00 +0000")!, duration: .afternoon)
        let day3 = Day(id: 3, date: formatter.date(from: "2018-06-03 00:00:00 +0000")!, duration: .fullday)
        let day4 = Day(id: 4, date: formatter.date(from: "2018-06-05 00:00:00 +0000")!, duration: .morning)
        let day5 = Day(id: 5, date: formatter.date(from: "2018-06-06 00:00:00 +0000")!, duration: .afternoon)
        let day6 = Day(id: 6, date: formatter.date(from: "2018-06-07 00:00:00 +0000")!, duration: .fullday)
        let day7 = Day(id: 7, date: formatter.date(from: "2018-06-09 00:00:00 +0000")!, duration: .morning)
        let day8 = Day(id: 8, date: formatter.date(from: "2018-06-10 00:00:00 +0000")!, duration: .afternoon)
        let day9 = Day(id: 9, date: formatter.date(from: "2018-06-11 00:00:00 +0000")!, duration: .fullday)
        let day10 = Day(id: 10, date: formatter.date(from: "2018-06-13 00:00:00 +0000")!, duration: .morning)
        let day11 = Day(id: 11, date: formatter.date(from: "2018-06-13 00:00:00 +0000")!, duration: .afternoon)
        
        let day12 = Day(id: 10, date: formatter.date(from: "2018-06-18 00:00:00 +0000")!, duration: .morning)
        let day13 = Day(id: 11, date: formatter.date(from: "2018-06-18 00:00:00 +0000")!, duration: .afternoon)
        
        let day20 = Day(id: 3, date: formatter.date(from: "2018-06-20 00:00:00 +0000")!, duration: .fullday)
        let day21 = Day(id: 3, date: formatter.date(from: "2018-06-21 00:00:00 +0000")!, duration: .fullday)
        let day22 = Day(id: 3, date: formatter.date(from: "2018-06-22 00:00:00 +0000")!, duration: .fullday)
        let day23 = Day(id: 3, date: formatter.date(from: "2018-06-23 00:00:00 +0000")!, duration: .fullday)
        ...
        completion([request1, request2, request3, request4, request5, request6, request7, request8, request9, request10, request11, request12,request13, request14])
    }
}
